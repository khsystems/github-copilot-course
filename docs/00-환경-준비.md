...
설치가 끝나면 Git에게 내 이름과 이메일을 알려 줍니다. 이 정보는 앞으로 기록되는 변경 내역에 작성자 표시로 사용됩니다.

**Windows**에서는 시작 메뉴에서 **Git Bash**를 열고, **macOS**에서는 **터미널(Terminal)**을 엽니다. 그런 다음 아래 두 줄을 한 줄씩 입력하고 각 줄마다 Enter를 누릅니다. 따옴표 안의 이름과 이메일은 자신의 것으로 바꿔 주세요.
...
> [!TIP]
> `--global`은 이 컴퓨터 전체에 적용한다는 뜻입니다. 한 번만 설정하면 됩니다.

제대로 설정됐는지 확인하려면 아래 명령을 입력합니다. 방금 입력한 이름과 이메일이 나오면 성공입니다.
...
- [ ] Git을 설치했습니다.
- [ ] Git에 이름과 이메일을 설정했습니다.
- [ ] Node.js LTS를 설치했습니다.
- [ ] Copilot 채팅 창이 보입니다.

---

[다음 STEP: 01 GitHub Copilot 이해 →](01-GitHub-Copilot-이해.md)
